...
namespace OpportunityAPI.Controllers
{
    ...
    {
        private readonly OpportunityAPIContext _context;

        public OpportunitiesController(OpportunityAPIContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Opportunity>> PostOpportunity(Opportunity opportunity)
        {
          if (_context.Opportunity == null)
          {
              return Problem("Entity set 'OpportunityAPIContext.Opportunity'  is null.");
          }
